...
1. $t_D = f_{N}\left( D \right) = GM\left(\prod \limits_{n \in N}{g\left( D, n \right)^{\prod \limits_{q \in N}{w\left( n \leftarrow q \right)}}} \right) = \sqrt[5]{g\left(D, C\right)^1 \cdot g\left(D, D\right)^2 \cdot g\left(D, A\right)^2}$
